...
namespace GoFoodBeverage.Infrastructure.Migrations
{
    ...
    [Migration("20220718105449_Create-OrderCartSession-Table")]
    partial class CreateOrderCartSessionTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoFoodBeverage.Domain.Entities.PackageDuration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GoFoodBeverage.Domain.Entities.PackagePackagePermission", b =>
                {
                    ...
                    b.ToTable("PackagePackagePermission");
                });

            modelBuilder.Entity("GoFoodBeverage.Domain.Entities.PackagePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("PackagePermissionGroupId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("PackagePermissionGroupId");

                    b.ToTable("PackagePermission");
                });

            modelBuilder.Entity("GoFoodBeverage.Domain.Entities.PackagePermissionGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PackagePermissionGroup");
                });

            modelBuilder.Entity("GoFoodBeverage.Domain.Entities.PackagePermissionMapping", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PackagePermissionMapping");
                });
            ...
            modelBuilder.Entity("GoFoodBeverage.Domain.Entities.PackagePackagePermission", b =>
                {
                    b.HasOne("GoFoodBeverage.Domain.Entities.Package", "Package")
                        .WithMany("PackagePackagePermissions")
                        .HasForeignKey("PackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GoFoodBeverage.Domain.Entities.PackagePermission", "PackagePermission")
                        .WithMany("PackagePackagePermissions")
                        .HasForeignKey("PermissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("PackagePermission");
                });

            modelBuilder.Entity("GoFoodBeverage.Domain.Entities.PackagePermission", b =>
                {
                    b.HasOne("GoFoodBeverage.Domain.Entities.PackagePermissionGroup", "PackagePermissionGroup")
                        .WithMany("PackagePermissions")
                        .HasForeignKey("PackagePermissionGroupId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PackagePermissionGroup");
                });

            modelBuilder.Entity("GoFoodBeverage.Domain.Entities.PackagePermissionMapping", b =>
                {
                    b.HasOne("GoFoodBeverage.Domain.Entities.Package", "Package")
                        .WithMany("PackagePermissionMappings")
                        .HasForeignKey("PackageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GoFoodBeverage.Domain.Entities.Package", b =>
                {
                    b.Navigation("PackagePackagePermissions");

                    b.Navigation("PackagePermissionMappings");
                });
