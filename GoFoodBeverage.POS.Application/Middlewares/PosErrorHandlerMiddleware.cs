...
{
    public class PosErrorHandlingMiddleware
    {
        private readonly RequestDelegate _next;
        private readonly IWebHostEnvironment _hostingEnvironment;
        private readonly ILogger<PosErrorHandlingMiddleware> _logger;

        public PosErrorHandlingMiddleware(
            RequestDelegate next,
            IWebHostEnvironment hostingEnvironment,
            ILogger<PosErrorHandlingMiddleware> logger)
        {
            _next = next;
